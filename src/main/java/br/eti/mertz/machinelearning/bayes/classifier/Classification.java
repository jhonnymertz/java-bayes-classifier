...
public class Classification<T, K> {
    ...
    /**
     * Constructs a new br.eti.mertz.machinelearning.bayes.classifier.Classification with the parameters given and a default
     * probability of 1.
     *
    ...
    /**
     * Constructs a new br.eti.mertz.machinelearning.bayes.classifier.Classification with the parameters given.
     *
     * @param featureset  The featureset.
     * @param category    The category.
