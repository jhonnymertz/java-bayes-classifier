...
public class RunnableExample {
    ...
    public static void main(String[] args) {
         ...
         * a br.eti.mertz.machinelearning.bayes.classifier.Classification Object, that contains the given featureset,
        ...
        /*
         * The br.eti.mertz.machinelearning.bayes.classifier.BayesClassifier extends the abstract br.eti.mertz.machinelearning.bayes.classifier.Classifier and provides
         ...
         * [
         *   br.eti.mertz.machinelearning.bayes.classifier.Classification [
         *     category=negative,
